   ...
   <br>Sistem Informasi Geografis Fasilitas Umum Kota
	...
	<div id='search'>
          ...
          <div id='Judul'>
			...
			<a href ="http://bangkinang-maps.tk/Buku Petunjuk Penggunaan Sistem.pdf" 
              style=
...
<iframe width="640" height="360" src="http://www.youtube.com/embed/wquOwOPuLus?feature=player_detailpage" frameborder="0" allowfullscreen></iframe>		
 ...
 <br>
		...
		<a href="http://tif.poltek-kampar.ac.id" style=
				"text-decoration:none;color:#fff;" target="_blank">&nbsp;&nbsp;Copyright &copy; 2012 TIF '09 Politeknik Kampar
